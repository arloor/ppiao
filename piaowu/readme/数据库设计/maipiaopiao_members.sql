...
(
    ...
    role varchar(25) DEFAULT 'ROLEmember',
    ...
    pinindex int(11) COMMENT '验证码序号，用于确定验证码是否失效'
);
CREATE UNIQUE INDEX members_email_uindex ON maipiaopiao.members (email);
INSERT INTO maipiaopiao.members (email, uname, passwd, role, paykey, balance, bonus, paynum, timesign, timecancel, pin, pinindex) VALUES ('1293181335@qq.com', 'arloor', 'arloor', 'ROLE_MEMBER', '123456', 100, 100, 1234, '2018-02-02 05:29:47', null, '456', 25255);